...
local curr_dir = gfs.get_configuration_dir() .. '/widgests/battery'
...
local function worker(user_args)
  ...
  -- User Options
  local font                         = args.font or 'Operator Mono Lig 8'
  ...
  local warning_msg_icon             = args.warning_msg_icon or curr_dir .. '/spaceman.jpg'
