...
zstyle ':vcs_info:*' formats \
  " %F{green}%B%{$__BULL[ITALIC_ON]%}%{ %2G%}%s%%b%{$__BULL[ITALIC_OFF]%} %f%F{blue}%{ %2G%}%B%{$__BULL[ITALIC_ON]%}%b%%b%{$__BULL[ITALIC_OFF]%}%f%F{yellow}%{$__BULL[ITALIC_ON]%} %{ %2G%}%7.7i %{$__BULL[ITALIC_OFF]%}%f%c%u%F{green}%f %m"
