...
augroup filetype_indentation " {{{3
  ...
  autocmd FileType vim,sh,zsh,markdown,tex,plaintex,bib,text,yaml,ruby,xml,xdefaults,tmux
...
augroup fyletype_folding_method " {{{3
  ...
  " Indentation
  autocmd FileType make,python,bib,go,json,html,css,javascript,yaml,ruby,xml,haskell,lhaskell
