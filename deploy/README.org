...
# aur depends on: libtermkey msgpack-c libvterm libtree-sitter.so
#+begin_src shell
  sudo pacman -S --needed ninja tree-sitter
  sudo pacman -S --needed libtermkey libuv msgpack-c unibilium libvterm luajit libluv # neovim 4 dependencies
#+end_src
