Set_var {
  ...
  nvim_tree_auto_open            = { 'g', 0 },
  nvim_tree_auto_close           = { 'g', 0 },
  nvim_tree_quit_on_open         = { 'g', 1 },
  nvim_tree_follow               = { 'g', 0 },
  nvim_tree_indent_markers       = { 'g', 0 },
  nvim_tree_hide_dotfiles        = { 'g', 0 },
  nvim_tree_git_hl               = { 'g', 0 },
...
vim.api.nvim_set_keymap( 'n', '<F14>',  ':<C-U>NvimTreeFindFile<CR>',
  { noremap = true, silent = true } )
vim.api.nvim_set_keymap( 'n', '<S-F2>', ':<C-U>NvimTreeFindFile<CR>',
  { noremap = true, silent = true } )
